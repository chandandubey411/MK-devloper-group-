      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="flex flex-col gap-4">
            <Link to="/" className="flex items-center gap-3">
              ...
              <div className="flex flex-col leading-none">
                ...
                <span className="text-[12px] font-light tracking-[0.18em] text-primary uppercase">Group</span>
              </div>
            </Link>
          ...
          <div className="flex flex-col gap-6">
            ...
            <ul className="flex flex-col gap-3 text-sm text-white/70 font-sans font-light">
              <li>
                <Link to="/services" className="hover:text-primary transition-colors">Construction</Link>
              </li>
              <li>
                <Link to="/services" className="hover:text-primary transition-colors">Property Development</Link>
              </li>
              <li>
                <Link to="/services" className="hover:text-primary transition-colors">Commercial Buildings</Link>
              </li>
              <li>
                <Link to="/services" className="hover:text-primary transition-colors">Residential Projects</Link>
              </li>
              <li>
                <Link to="/services" className="hover:text-primary transition-colors">Architecture & Planning</Link>
              </li>
              <li>
                <Link to="/services" className="hover:text-primary transition-colors">Luxury Interior Design</Link>
              </li>
            </ul>
          </div>
          ...
          <div className="flex flex-col gap-6">
            ...
            <ul className="flex flex-col gap-4 text-sm text-white/70 font-sans font-light">
              ...
              <li className="flex gap-3 items-center">
                ...
                <a href="tel:+918010029100" className="hover:text-primary transition-colors">+91 80100 29100</a>
              </li>
              <li className="flex gap-3 items-center">
                <FaEnvelope className="text-primary shrink-0" />
                <a href="mailto:mkdevelopergroup@gmail.com" className="hover:text-primary transition-colors">mkdevelopergroup@gmail.com</a>
              </li>
            </ul>
          </div>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-white/50 font-sans">
          <p>
            MK Developer & Group &copy; 2026. All Rights Reserved.
          </p>
